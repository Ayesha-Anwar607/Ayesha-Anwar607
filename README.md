...
- **A Novel Framework Integrating Epidemiological Features and Machine Learning Models for Prostate Cancer Detection on Imbalanced Dataset**
  Mohsin, Anwar, Hashmi, et al. — *International Journal of Computational Intelligence Systems (Springer), 2026*
...
- 🤖 **Autonomous Revenue Agent** — Event-driven AI agent (Google ADK + Gemini) that monitors CRM and invoicing data, flags issues, and streams live updates over SSE, with a 4-layer security architecture for safe autonomous actions
...
- 🧠 **Brain Tumor Detection** — Distributed deep learning pipeline using VGG16 and PySpark
- 🏙️ **Spatio-Temporal Crime Analysis** — Large-scale urban analytics mapping and forecasting regional crime trends using parallel computation
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=flat-square&logo=gmail&logoColor=white)](mailto:hayesha1744@gmail.com)
